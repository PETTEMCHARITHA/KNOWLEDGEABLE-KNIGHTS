...
image1 = Image.open("C:\\Users\\chari\\OneDrive\\Documents\\oldman_chess.gif")
...
def open_second_window():
    ...
    def on_click(row, col):
        ...
        label = tk.Label(output, text=f"The number of valid moves for the knight is {count_moves(row, col)}",font=("Arial",25))
        label.pack()
...
def possible_knight_tour(x, y, move_count, n, visited, canvas):
    ...
    pygame.init()
    pygame.mixer.music.load("C:\\Users\\chari\\OneDrive\\Documents\\knightwalk (online-audio-converter.com).mp3")
...
def create_welcome_window():
    ...
    pygame.init()
    pygame.mixer.music.load("C:\\Users\\chari\\OneDrive\\Documents\\audio.unknown")
    pygame.mixer.music.play()
   
    

    image = tk.PhotoImage(file="C:\\Users\\chari\\Downloads\\knighttttt.ppm")  
    image_label = tk.Label(welcome_root, image=image,width=1000,height=550,bg="#FFC0CB")
    image_label.pack()
...
def open_main_window(previous_window):
    ...
    bg_image = tk.PhotoImage(file="C:\\Users\\chari\\OneDrive\\Documents\\knight56.png") 
